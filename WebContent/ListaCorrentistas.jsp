...
<f:view>
	<h:form>
		...
		<h:dataTable value="#{controladorCorrentista.correntistas}"
			var="correntista" border="1">
			<h:column>
				<f:facet name="header">
			...
			<h:column>
				<h:commandButton image="imagens/edit.png"
					action="#{controladorCorrentista.mostraDados}"
					alt="Editar Correntista" />&nbsp;&nbsp;
<h:commandButton image="imagens/delete.png"
					action="#{controladorCorrentista.excluir}"
					alt="Excluir Correntista"
					onclick="if (!confirm('Deseja excluir o item?')) return false;" />
			</h:column>
		</h:dataTable>
		<h:commandButton image="imagens/window_new.png" action="novo"
			alt="Novo Correntista" />
	</h:form>
</f:view>
</html>
